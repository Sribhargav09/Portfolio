          ...
          <div className="grid gap-[1.875rem] md:grid-cols-2 grid-cols-1 items-center">
            ...
            <div>
              <div className="featuredCap relative w-full mt-10 md:mt-0">
                ...
                <h2 className="font-bold text-[2.3rem] sm:text-[3rem] md:text-[3rem] lg:text-[3rem] xl:text-[3rem] font-Poppins text-white uppercase">
                    Sri Bhargav Krishna
                  <span className="font-normal text-[2.3rem] sm:text-[3rem] md:text-[3rem] lg:text-[3rem] xl:text-[3rem] text-accent font-Poppins uppercase ml-2">
                   Adusumilli
                  </span>
                </h2>
                {/* <h5 className="md:justify-start justify-center font-bold text-[1rem] sm:text-[1.125rem] md:text-[1.25rem] font-Poppins text-white uppercase flex items-center gap-2.5 tracking-[1px]">
                  ...
                  Sr Software Engineer | Co-Founder of MindQuest Technology Solutions LLC | Honorary Technical Advisor | Forbes Technology Council Member | The Research World Fellow Member | Startup Investor
                </h5> */}
