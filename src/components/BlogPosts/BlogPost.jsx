    ...
    <section className="postsWrap py-[5rem] sm:py-[6rem] md:py-[7.5rem] relative w-full">
      ...
      <div className="container sm:container md:container lg:container xl:container 2xl:container mx-auto">
        <SectionTitle
          title="Featured"
          titleInner="Posts"
          desc="Explore a curated selection of my most impactful featured articles, insights, media prints, and thought leadership pieces in the fields of AI, machine learning, and blockchain technology"
        ></SectionTitle>
