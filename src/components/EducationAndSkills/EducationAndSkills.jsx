...
const EducationAndSkills = () => {
  return (
    <section className="eduAndWorkWrap mb-5 py-[5rem] sm:py-[6rem] md:py-[7.5rem] relative w-full">
      ...
      <div className="container sm:container md:container lg:container xl:container mx-auto">
        <SectionTitle3
          title="Education &"
          titleInner="Skills"
          desc="Explore my academic background and the diverse skills that drive my expertise and innovation in technology."
        ></SectionTitle3>
